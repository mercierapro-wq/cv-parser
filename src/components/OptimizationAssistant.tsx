      ...
      <div className="relative w-full max-w-2xl bg-white rounded-[2.5rem] shadow-2xl border border-slate-200 overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-8 duration-300">
        ...
        {isOptimizing && (
          <div className="absolute inset-0 bg-white/80 backdrop-blur-sm z-50 flex flex-col items-center justify-center p-10 text-center">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-3">L&apos;IA travaille sur votre CV</h3>
            <p className="text-slate-600 max-w-xs mx-auto leading-relaxed">
              Nous réécrivons vos expériences pour qu&apos;elles correspondent parfaitement à vos objectifs. Cela peut prendre quelques secondes...
            </p>
